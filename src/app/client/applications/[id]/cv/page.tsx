 ...
 * WAT:    Standalone printbare CV-pagina voor de klantzone — zelfde weergave als de
 *         staff-variant, maar de application wordt opgehaald via `getSharedApplicationForClient`
 *         zodat een client alleen het CV van een met zijn bedrijf gedeeld profiel kan zien.
 */
