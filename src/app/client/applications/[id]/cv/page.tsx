 ...
 * WAT:    Standalone printbare CV-pagina voor het klantportaal — zelfde weergave als de
 *         staff-variant, maar de application komt via `getSharedApplicationForClient` binnen
 *         zodat een klant alleen het CV van een met hen gedeelde sollicitatie kan zien.
 */
