...
import { DOCUMENT_LABELS, type ApplicationDocument, type SharedApplication } from '@/types/database'
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent>
          {documents.length === 0 ? (
            <p className="text-sm text-muted-foreground">Nog geen CV beschikbaar.</p>
          ) : (
