...
import { TrainingTracker } from '@/components/admin/TrainingTracker'
      ...
      <div className="space-y-6 lg:col-span-2">
        ...
        <Tabs defaultValue="profiel">
          ...
          <TabsContent value="trainingen" className="pt-4">
            <TrainingTracker applicationId={application.id} trainings={trainings} progress={trainingProgress} />
          </TabsContent>
