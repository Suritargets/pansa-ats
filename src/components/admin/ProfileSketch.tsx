...
import { TrainingProgressEditor } from '@/components/admin/TrainingProgressEditor'
...
export function ProfileSketch({
  ...
  trainingProgress: CandidateTrainingProgressRow[]
}) {
      ...
      <div className="space-y-6 lg:col-span-2">
        ...
        <Tabs defaultValue="profiel">
          ...
          <TabsContent value="trainingen" className="pt-4">
            <TrainingProgressEditor applicationId={application.id} catalog={trainingCatalog} progress={trainingProgress} />
          </TabsContent>
