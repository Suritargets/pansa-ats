...
import { TrainingsAssignment } from '@/components/admin/TrainingsAssignment'
      ...
      <div className="space-y-6 lg:col-span-2">
        ...
        <Tabs defaultValue="profiel">
          ...
          <TabsContent value="trainingen" className="pt-4">
            <TrainingsAssignment applicationId={application.id} trainings={trainings} progress={trainingProgress} />
          </TabsContent>
